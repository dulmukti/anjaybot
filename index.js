...
*/
const A187 = '𝗪𝗔 𝗕𝗢𝗧'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] WA BOT ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => wa bot active`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => wa bot active`)
})
...
conn.sendMessage(id, ' *Owner WA BOT wa.me/+6285314948812* ' ,MessageType.text);
}
else if (text == '#help'){
...
conn.sendMessage(id, ' *Creator WA BOT wa.me/+6285314948812* ' ,MessageType.text);
}
else if (text == 'Pagi'){
...
conn.sendMessage(id, ' _🗣️Terimakasih telah menggunakan *WHATSAPP BOT* , Follow Instagram Mimin Yah😻 : https://instagram.com/dulmukti_id' ,MessageType.text);
}
else if (text == '#menu1'){
conn.sendMessage(id, ' _🗣️Terimakasih telah menggunakan *WHATSAPP BOT* , Follow Instagram Mimin Yah😻 : https://instagram.com/dulmukti_id' ,MessageType.text);
}
